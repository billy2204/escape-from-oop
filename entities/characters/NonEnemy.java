...
public abstract class NonEnemy extends Entity {
    ...
    // --- 1. LOGIC DELAY SPAWN ---
    protected long spawnTime; // Thời điểm sinh ra
    
    public NonEnemy(float x, float y, int width, int height, String type) {
        super(x, y, width, height, type);
        // Ghi lại thời gian lúc mới tạo ra
    ...
    protected boolean shouldChasePlayer(Vector2D targetPos) {
        // --- CHECK DELAY 1.5 GIÂY ---
        // Nếu thời gian hiện tại - thời gian sinh ra < 1500ms (1.5s) -> Chưa làm gì cả
    ...
    // ... (Giữ nguyên các hàm getSeekForce, getSeparationForce bên dưới) ...
    ...
    protected Vector2D getSeparationForce(float radius, float strength) {
        // Copy lại logic cũ của bạn (để ngắn gọn mình không paste lại đoạn này)
        // Code logic giống hệt các câu trả lời trước
